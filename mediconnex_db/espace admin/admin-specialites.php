...
<head>
    ...
    <title>Gestion des spécialités - MédiConnex</title>
...
<body>
    <div class="gestion-wrapper">
        ...
        <div class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="#"><i class="fa-solid fa-history"></i> Logs</a></li>
                <li><a href="#"><i class="fa-solid fa-user-cog"></i> Profil</a></li>
            </ul>
        ...
        <div class="main-content">
            <div class="page-header">
                ...
                <a href="admin-ajout-specialite.php" class="btn-add">
                    <i class="fa-solid fa-plus"></i> Ajouter une spécialité
                </a>
            </div>

            <div class="table-container">
                <table id="specialitesTable">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Spécialité</th>
    ...
    <div id="modalModif" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2><i class="fa-solid fa-pen"></i> Modifier spécialité</h2>
    ...
    <script>
        // Données initiales des spécialités
        let specialites = [
            { id: 'SP001', nom: 'Cardiologie' },
            { id: 'SP002', nom: 'Neurologie' },
            { id: 'SP003', nom: 'Dermatologie' },
            { id: 'SP004', nom: 'Pédiatrie' },
            { id: 'SP005', nom: 'Gynécologie' },
            { id: 'SP006', nom: 'Médecine générale' }
        ];

        let ligneEnCours = null;

        function afficherSpecialites() {
            const tbody = document.getElementById('specialitesBody');
            tbody.innerHTML = '';

            specialites.forEach(s => {
                const ligne = document.createElement('tr');
                ligne.setAttribute('data-id', s.id);
                ligne.setAttribute('data-nom', s.nom);
                ligne.innerHTML = `
                    <td>${s.id}</td>
                    <td>${s.nom}</td>
                    <td class="action-icons">
                        <i class="fa-solid fa-pen" title="Modifier" onclick="ouvrirModal(this)"></i>
                        <i class="fa-solid fa-trash" title="Supprimer" onclick="supprimerSpecialite(this)"></i>
                    </td>
                `;
        ...
        // Supprimer
        window.supprimerSpecialite = function(icone) {
            if (confirm('🗑️ Supprimer cette spécialité ?')) {
